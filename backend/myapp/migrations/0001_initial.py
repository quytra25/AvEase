    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('event_type', models.CharField(choices=[('weekly', 'Weekly Event'), ('single_day', 'Single Day Event'), ('multi_day', 'Multi Day Event'), ('rsvp_single', 'RSVP Single Day Event'), ('rsvp_multi', 'RSVP Multi Day Event')], max_length=20, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('event', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='multi_day_details', to='myapp.event')),
            ],
        ),
        migrations.CreateModel(
            name='Participant',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('event', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='single_day_details', to='myapp.event')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            name='DateTimeAvailability',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('selected_date', models.DateField()),
                ('start_time', models.TimeField()),
                ('end_time', models.TimeField()),
                ('participant', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='datetime_availabilities', to='myapp.participant')),
            ],
            options={
